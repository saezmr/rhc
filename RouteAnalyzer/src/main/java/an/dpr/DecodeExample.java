...
public class DecodeExample {
    private static class Listener implements FileIdMesgListener, UserProfileMesgListener, HrZoneMesgListener,
	    CoursePointMesgListener {

	@Override
	public void onMesg(HrZoneMesg mesg) {
	    System.out.println(mesg.getName());
	    System.out.println(mesg.getHighBpm());
	}
   ...
   public static void main(String[] args) {
	...
	// args = new String[] {
	// "/home/rsaez/Documents/GarminActivities/fit/2013-08-18-09-16-57.fit"
	// };
	// try {
