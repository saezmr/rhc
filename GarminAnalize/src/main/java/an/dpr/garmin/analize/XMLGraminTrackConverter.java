...
public class XMLGraminTrackConverter {

    private static final Logger log = Logger
	    .getLogger(XMLGraminTrackConverter.class);
...
//	log.debug(listado2);
     ...
     */
    public XMLGraminTrackConverter(){}
    
    public static List<HRBean> getHRList(String xml) throws XmlPullParserException{
...
//	    log.debug(parser.getName());
    ...
    public static List<AltitudBean> getAltitudList(String xml) throws XmlPullParserException{
