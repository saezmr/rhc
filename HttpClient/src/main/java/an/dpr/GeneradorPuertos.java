...
public class GeneradorPuertos {
	...
	private String altaPuerto(Puerto puerto) throws IOException {
		...
		params.add(new BasicNameValuePair("nombreExtendido", puerto
				.getNombreExtendido()));
		params.add(new BasicNameValuePair("descripcion", puerto
				.getDescripcion()));
		params.add(new BasicNameValuePair("comarca",
				puerto.getComarca() != null ? puerto.getComarca().getNombre()
						: null));
		params.add(new BasicNameValuePair("km", puerto.getKm() != null ? String
				.valueOf((int) (puerto.getKm() * 100)) : null));
		params.add(new BasicNameValuePair("desnivelMetros", puerto
				.getDesnivelMetros() != null ? String.valueOf(puerto
				.getDesnivelMetros()) : null));
		params.add(new BasicNameValuePair("desnivelMedio", puerto
				.getDesnivelMedio() != null ? String.valueOf((int) (puerto
				.getDesnivelMedio() * 100)) : null));
		params.add(new BasicNameValuePair("altitud",
				puerto.getAltitud() != null ? puerto.getAltitud().toString()
						: null));
		params.add(new BasicNameValuePair("imagen",
				puerto.getImagen() != null ? Base64.encodeBase64String(puerto
						.getImagen()) : null));
